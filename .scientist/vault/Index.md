...
- [Advanced Data Analysis Planning Frameworks](Research/Advanced%20Data%20Analysis%20Planning%20Frameworks.md): 7 world-class procedural frameworks — Pre-registration (10-component protocol + template), Exploratory vs Confirmatory firewall, DMAIC applied to data science, Tukey EDA methodology (7 steps + principles), DOE (Fisher's 3 principles + 8-step protocol), Sequential Analysis stopping rules (SPRT + alpha spending), Sensitivity/Robustness (3-level protocol + reporting template), Integrated Master Protocol (22-step synthesis)
- [Genius-Level Thinking Protocols for Data Science](Research/Genius-Level%20Thinking%20Protocols%20for%20Data%20Science.md): 9 cognitive strategies of the top 0.1% — Feynman (understand before solving), First Principles (reason from fundamentals), Inversion (avoid stupidity), Pre-Mortem (prospective hindsight +30% failure detection), Bayesian Thinking (calibrated confidence updating), Second-Order Thinking (consequences of consequences), Thought Experiments (Einstein's gedankenexperiment), Adversarial Thinking (5-persona red team), Circle of Competence (know what you don't know) + Integrated Genius Pre-Flight and Post-Flight protocols

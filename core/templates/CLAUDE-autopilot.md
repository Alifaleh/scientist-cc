...
**Read `.autopilot/vault/Index.md` to know what you've learned.**
...
**The Obsidian vault is the deliverable.** `.autopilot/vault/` is your brain. Document everything there with proper format (wikilinks, frontmatter, callouts, tags). Code is temporary. Knowledge is permanent.
